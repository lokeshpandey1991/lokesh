...
snro.heroMedia = (function(window, $) {
  ...
  let $heroBannerCnt = $('.heroBannerContainer'),
    videoTracking;
  ...
  let init = function() {
    let assetType = '';
    let videoPlayerFunction = (context,playerId,containerId,asseType) => {
      let videoLink = $('#'+playerId).data('fileref'),
      ...
      if(asseType==='video') {
        ...
        $volCtrlBtn.addClass('mute');
        // Attach listeners
        $videoPlayBtn.on('click', (e) => {
          let $parentContainer = $(e.currentTarget).parents('.heroBannerContainer');
        ...
        $playBtn.on('click', (e) => {
          ...
          let $jPlayer = $(e.currentTarget).parents('.heroBannerContainer').find('.jp-jplayer').attr('id'),
        ...
        // Full-screen
        $fullScrBtn.on('click', (e) => {
          let currentPlayerId=$(e.currentTarget).parents('.heroBannerContainer').find('.jp-jplayer').attr('id'),
        ...
        // Volume control
        $volCtrlBtn.on('click', (e) => {
          let $volCtrlBtn = $(e.currentTarget).parents('.heroBannerContainer').find('.vol-ctrl'),
