...
public class SearchBarFilterModelTest {
    ...
    public void testProductDetailModel() throws LoginException {
        SearchBarFilterModel modelObject = context.resourceResolver().getResource(productNodePath + "/jcr:content")
                .adaptTo(SearchBarFilterModel.class);
